...
class SubmitPredictJob:
    ...
    def process(self):        
        # =========================================================
        # load predict configurations
        # =========================================================
        # WEEK_FLAG = "last_week"
        PROJECT_DIR = settings.PROJECT_DIR
        PROJECT_PREFIX = settings.HIVE_TABLE_PREFIX

        # if WEEK_FLAG == "last_week":
        #     WEEK_NUMBER = params.LAST_WEEK_NUMBER
        # elif WEEK_FLAG == "current_week":
        ...
        DATA_PROC_CONFIG_PATH = Path(PROJECT_DIR) / "mlmodels/ctr_shoplikelihood_v4/config/predict.yaml"
        ...
        predictions_output_table = f"shoplikelihood_v4.{PROJECT_PREFIX}customer_purchase_predictions_{CURRENT_WEEK_NUMBER}"
...
submit_predict_job = SubmitPredictJob()
